                                   ...
                                   m_center_y(0)
{
    ...
    {
        cout << "\n  Error at Ring constructor (Inner radius can`t be less or equal to outer radius).";
        cout << "\n  Constructing with Default parameters instead.";
        *this = Ring();
    }
}
...
int main()
{
    ...
    show_constructed_object_description = true;
