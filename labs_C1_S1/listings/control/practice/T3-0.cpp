/* 
Составить программу, вычисляющую таблицу значений функции: (...)
если х[–4 ; 4], шаг 0,3. 
Параметр апринимает значения 1.2, 1.3, 1.4, 1.5, 1.6.
Для каждого значения параметра строить отдельную табличку y(x) 
*/
